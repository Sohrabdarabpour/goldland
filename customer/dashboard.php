...
$avatar_path = !empty($user['avatar']) ? BASE_URL . $user['avatar'] : BASE_URL . 'assets/images/avatars/default-' . ($user['gender'] ?? 'other') . '.png';
            ...
            <aside class="dashboard-sidebar">
                <div class="user-profile">
                    ...
                    <div class="profile-image">
                        <img src="<?php echo $avatar_path; ?>" alt="پروفایل کاربر" onerror="this.src='<?php echo BASE_URL; ?>assets/images/avatars/default-other.png'">
                    </div>
